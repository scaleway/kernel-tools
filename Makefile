...
oldconfig olddefconfig menuconfig $(ARCH_CONFIG)_defconfig dtbs diff cache_stats uImage shell build tar-pkg uImage:: local_assets
...
.PHONY:	all build run menuconfig clean fclean ccache_stats tar-pkg
